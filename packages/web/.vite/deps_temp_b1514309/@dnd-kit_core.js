...
// ../../node_modules/.bun/@dnd-kit+accessibility@3.1.1+83d5fd7b249dbeef/node_modules/@dnd-kit/accessibility/dist/accessibility.esm.js
var hiddenStyles = {
  display: "none"
};
...
// ../../node_modules/.bun/@dnd-kit+core@6.3.1+67f6792bdf102c28/node_modules/@dnd-kit/core/dist/core.esm.js
var DndMonitorContext = Q(null);
...
function useDragOverlayMeasuring(_ref) {
  ...
  const handleNodeChange = q((element) => {
...
var InternalContext = Q(defaultInternalContext);
var PublicContext = Q(defaultPublicContext);
...
var DndContext = M(function DndContext2(_ref) {
  ...
  const bindActivatorToSensorInstantiator = q((handler, sensor) => {
...
function useDroppable(_ref) {
  ...
  const handleNodeChange = q((newElement, previousElement) => {
    if (!resizeObserver) {
      return;
    }
    if (previousElement) {
...
function AnimationManager(_ref) {
  ...
  return Rn.createElement(Rn.Fragment, null, children, clonedChildren ? _n(clonedChildren, {
    ref: setElement
  }) : null);
}
...
function NullifiedContextProvider(_ref) {
  ...
  return Rn.createElement(InternalContext.Provider, {
...
var PositionedOverlay = D((_ref, ref) => {
  let {
    as,
    activatorEvent,
...
var DragOverlay = Rn.memo((_ref) => {
  ...
  const transform = x(ActiveDraggableContext);
  ...
  return Rn.createElement(NullifiedContextProvider, null, Rn.createElement(AnimationManager, {
    animation: dropAnimation
  }, active && key2 ? Rn.createElement(PositionedOverlay, {
    key: key2,
    id: active.id,
    ref,
    as: wrapperElement,
